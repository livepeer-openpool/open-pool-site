  ...
  */
  head: {
    ...
    meta: [
      ...
      { property: 'og:site_name', content: 'open-pool.com' },
      { property: 'og:locale', content: 'en_US' },
      { property: 'og:type', content: 'website' },
      // Twitter
      { property: 'twitter:site', content: 'open-pool.com' },
      { property: 'twitter:domain', content: 'open-pool.com' },
      { property: 'twitter:creator', content: '@xodeapp' },
